...
% TODO in the above equation:
% Define sigma function
% Range of T (make sure it's clear that this is discrete)
...
starting at time $T$. The following observations can be made about this model.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        practical implementation of the optimisation algorithm is only possible with a relativeley
    ...
    rates.
    \item $\sigma_i(T)$ is the maturity dependent vo
\end{itemize}
